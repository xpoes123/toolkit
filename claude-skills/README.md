...
| `skills/project-deep-dive/` | Fan out subagents to deep-dive a project, merge fresh ideas with your existing TODOs/backlog into one reprioritized scoped roadmap, publish + notify | Generic from the start — composes with `notify/` and `share-publish.md` |
